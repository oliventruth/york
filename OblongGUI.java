		...
		{         
			...
			calculateButton.setOnAction( e ->                     
								{    // check that fields are not empty     
									...
									else if (Double.parseDouble(lengthField.getText()) == 0 || Double.parseDouble(heightField.getText()) == 0 )
										display.setText("Length or height cannot be zero");  
									
									else if (Double.parseDouble(lengthField.getText()) ==  Double.parseDouble(heightField.getText()) )
